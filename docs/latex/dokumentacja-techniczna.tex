...
\section{Część kliencka}
  ...
  \subsection{Sposób działania}
    ...
    Dzianie aplikacji klienta przedstawia rysunek \ref{fig:ClientSeq}.
...
\section{Prototyp klienta przeglądarkowego}
  ...
  \fiximg{eXtend-web-client-sequence.png}{Komunikacja między elementami systemu w przypadku podłączenia klienta za pomocą przeglądarki internetowej}{GuacComm}
