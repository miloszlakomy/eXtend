...
\section{Iteracja 1}
  ...
  \subsection{Analiza wykonalności i stworzenie prototypu}
    ...
    \fixscaledimg{it1_2.jpg}{[iteracja 1] główna część pulpitu widoczna na ekranie laptopa}{It1Test1}{0.75}
    \fixscaledimg{it1_3.jpg}{[iteracja 1] kontynuacja pulpitu laptopa na górnej części 24-segmentowego ekranu}{It1Test2}{0.75}
  ...
  \subsection{Spotkanie z klientem - podsumowanie iteracji 1}
    ...
    \fiximg{it1_4.jpg}{[iteracja 1] 18 z 24 monitorów podłączonych do laptopa. W tym przypadku obraz z lewej górnej części ekranu z jakiegoś powodu został zduplikowany jako tapeta lewej dolnej części, co jednak nie przeszkadzało w użyciu.}{It1Test3}
...
\section{Iteracja 2}
  ...
  \subsection{Problem czarnych obszarów w x11vnc}
    ...
    \scaledimg{it2_vnc_bug2.png}{Konfiguracja sprawiająca problemy - obraz na obszarze zaznaczonym na czerwono nie wyświetla się.}{It2VncBug1}{0.7}
    ...
    \fixscaledimg{it2_vnc_bug_screen4.png}{Układ outputów w niewykorzystanej przestrzeni wpływa na kształt niewidocznego obszaru.}{It2VncBugScreen4}{0.75}
    ...
    \vfill
    \fixscaledimg{it2_2.jpg}{[iteracja 2] test załatanej wersji x11vnc}{It2Test2}{0.8}
    \pagebreak
  ...
  \subsection{Uproszczenie konfiguracji}
    ...
    \fixscaledimg{it2_3.jpg}{[iteracja 2] test graficznego interfejsu konfiguracyjnego}{It2Test3}{0.8}
  ...
  \subsection{Guacamole - przeglądarkowy klient VNC}
    ...
    \fiximg{it2_6.jpg}{[iteracja 2] Test Guacamole - obraz z VNC widoczny w przeglądarce}{It2Guac2}
